        ...
        <>
                    ...
                    ? <>
                        ...
                        >
                            ...
                            <Form.Item style={{ textAlign: 'center' }}>
                                <Button style={{ backgroundColor: "#ca1515" }} type="primary" htmlType="submit">
                                    Nhận mã
                                </Button>
                            </Form.Item>
                        </Form>
            ...
            }
            {
                ...
                >
                    ...
                    >
                        <Button type="primary" style={{ backgroundColor: "#ca1515" }} htmlType="submit">
                            Xác nhận
                        </Button>
                    </Form.Item>
                </Form> : ""
            }
            {
                ...
                >
                    ...
                    >
                        <Button type="primary" style={{ backgroundColor: "#ca1515" }} htmlType="submit" onClick={navigateSignin}>
                            Xác nhận
                        </Button>
                    </Form.Item>
                </Form> : ""
