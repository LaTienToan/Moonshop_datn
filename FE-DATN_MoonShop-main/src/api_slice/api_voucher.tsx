...
export const voucherApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        // Edit Category
        editCategory: builder.mutation<IVoucher, IVoucher>({
            query: (voucher) => ({
...
export const { useGetVouchersQuery, useNameCategoryQuery, useCreateVoucherMutation, useEditCategoryMutation, useRemoveVoucherMutation, useGetVoucherQuery } = voucherApi